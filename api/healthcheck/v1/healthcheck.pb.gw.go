...
func RegisterHealthcheckAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server HealthcheckAPIServer) error {
	...
	mux.Handle("GET", pattern_HealthcheckAPI_Healthcheck_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/datalift.healthcheck.v1.HealthcheckAPI/Healthcheck", runtime.WithHTTPPathPattern("/healthcheck"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterHealthcheckAPIHandlerClient(ctx context.Context, mux *runtime.ServeMux, client HealthcheckAPIClient) error {
	...
	mux.Handle("GET", pattern_HealthcheckAPI_Healthcheck_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/datalift.healthcheck.v1.HealthcheckAPI/Healthcheck", runtime.WithHTTPPathPattern("/healthcheck"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
