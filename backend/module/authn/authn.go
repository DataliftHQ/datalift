...
import (
	...
	authnv1 "github.com/DataliftHQ/datalift/backend/api/authn/v1"
	"github.com/DataliftHQ/datalift/backend/gateway/log"
	...
	"github.com/DataliftHQ/datalift/backend/service/authn"
)

const Name = "datalift.module.authn"

func New(cfg *anypb.Any, log *zap.Logger, scope tally.Scope) (module.Module, error) {
	svc, ok := service.Registry["datalift.service.authn"]
	if !ok {
