...
import (
	context "context"
	errors "errors"
	v1 "github.com/DataliftHQ/datalift/backend/api/application/v1"
...
const (
	...
	ApplicationAPIName = "datalift.document.v1.ApplicationAPI"
)
...
const (
	...
	ApplicationAPICreateApplicationProcedure = "/datalift.document.v1.ApplicationAPI/CreateApplication"
	// ApplicationAPIDeleteApplicationProcedure is the fully-qualified name of the ApplicationAPI's
	// DeleteApplication RPC.
	ApplicationAPIDeleteApplicationProcedure = "/datalift.document.v1.ApplicationAPI/DeleteApplication"
	// ApplicationAPIGetApplicationProcedure is the fully-qualified name of the ApplicationAPI's
	// GetApplication RPC.
	ApplicationAPIGetApplicationProcedure = "/datalift.document.v1.ApplicationAPI/GetApplication"
	// ApplicationAPIListApplicationsProcedure is the fully-qualified name of the ApplicationAPI's
	// ListApplications RPC.
	ApplicationAPIListApplicationsProcedure = "/datalift.document.v1.ApplicationAPI/ListApplications"
	// ApplicationAPIUpdateApplicationProcedure is the fully-qualified name of the ApplicationAPI's
	// UpdateApplication RPC.
	ApplicationAPIUpdateApplicationProcedure = "/datalift.document.v1.ApplicationAPI/UpdateApplication"
)

// ApplicationAPIClient is a client for the datalift.document.v1.ApplicationAPI service.
...
// NewApplicationAPIClient constructs a client for the datalift.document.v1.ApplicationAPI service.
...
// CreateApplication calls datalift.document.v1.ApplicationAPI.CreateApplication.
...
// DeleteApplication calls datalift.document.v1.ApplicationAPI.DeleteApplication.
...
// GetApplication calls datalift.document.v1.ApplicationAPI.GetApplication.
...
// ListApplications calls datalift.document.v1.ApplicationAPI.ListApplications.
...
// UpdateApplication calls datalift.document.v1.ApplicationAPI.UpdateApplication.
...
// ApplicationAPIHandler is an implementation of the datalift.document.v1.ApplicationAPI service.
...
func NewApplicationAPIHandler(svc ApplicationAPIHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/datalift.document.v1.ApplicationAPI/", mux
}
...
func (UnimplementedApplicationAPIHandler) CreateApplication(context.Context, *connect_go.Request[v1.CreateApplicationRequest]) (*connect_go.Response[v1.CreateApplicationResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("datalift.document.v1.ApplicationAPI.CreateApplication is not implemented"))
}
...
func (UnimplementedApplicationAPIHandler) DeleteApplication(context.Context, *connect_go.Request[v1.DeleteApplicationRequest]) (*connect_go.Response[v1.DeleteApplicationResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("datalift.document.v1.ApplicationAPI.DeleteApplication is not implemented"))
}
...
func (UnimplementedApplicationAPIHandler) GetApplication(context.Context, *connect_go.Request[v1.GetApplicationRequest]) (*connect_go.Response[v1.GetApplicationResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("datalift.document.v1.ApplicationAPI.GetApplication is not implemented"))
}
...
func (UnimplementedApplicationAPIHandler) ListApplications(context.Context, *connect_go.Request[v1.ListApplicationsRequest]) (*connect_go.Response[v1.ListApplicationsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("datalift.document.v1.ApplicationAPI.ListApplications is not implemented"))
}
...
func (UnimplementedApplicationAPIHandler) UpdateApplication(context.Context, *connect_go.Request[v1.UpdateApplicationRequest]) (*connect_go.Response[v1.UpdateApplicationResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("datalift.document.v1.ApplicationAPI.UpdateApplication is not implemented"))
}
